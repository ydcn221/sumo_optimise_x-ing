...
def test_endpoint_catalog_is_deterministic_and_matches_expected():
    ...
    expected_pedestrian_ids = [
        ...
        crossing_id_main(350, "West"),
        crossing_id_main(350, "East"),
        "PedEnd.Minor.650.N_end.E_sidewalk",
        "PedEnd.Minor.650.N_end.W_sidewalk",
        "PedEnd.Minor.650.S_end.E_sidewalk",
        "PedEnd.Minor.650.S_end.W_sidewalk",
        crossing_id_main_split(650, "West", "north"),
        crossing_id_main_split(650, "West", "south"),
        crossing_id_main_split(650, "East", "north"),
        crossing_id_main_split(650, "East", "south"),
        "PedEnd.Minor.900.S_end.E_sidewalk",
        "PedEnd.Minor.900.S_end.W_sidewalk",
        crossing_id_main_split(900, "West", "north"),
        crossing_id_main_split(900, "West", "south"),
        crossing_id_main_split(900, "East", "north"),
        crossing_id_main_split(900, "East", "south"),
        "PedEnd.Minor.1000.N_end.E_sidewalk",
        "PedEnd.Minor.1000.N_end.W_sidewalk",
        "PedEnd.Minor.1000.S_end.E_sidewalk",
        "PedEnd.Minor.1000.S_end.W_sidewalk",
        crossing_id_main(1000, "West"),
        crossing_id_main(1000, "East"),
    ]
    assert [ep.id for ep in catalog_first.pedestrian_endpoints] == expected_pedestrian_ids
