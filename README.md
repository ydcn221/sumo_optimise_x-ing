...
* Files written:
  ...
  * `1-generated.tll.xml` — signal logic (traffic-light programs)
...
* **PlainXML**
  ...
  * `1-generated.tll.xml` — `<tlLogic>` definitions derived from signal profiles and controlled connections.
* **Build artifacts**
